    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <>
          ...
          <div 
            id="language-menu"
            className="fixed md:absolute bottom-0 md:bottom-full start-0 md:start-0 w-full md:w-[480px] md:mb-2 bg-white rounded-t-2xl md:rounded-xl shadow-2xl z-50 overflow-hidden transform transition-all duration-300 ease-out flex flex-col max-h-[85vh] md:max-h-none"
            role="menu"
          >
            {/* Mobile Header */}
