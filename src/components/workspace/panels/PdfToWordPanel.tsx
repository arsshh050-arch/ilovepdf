...
export function PdfToWordPanel({ mode, onModeChange }: PdfToWordPanelProps) {
  return (
    <div className="flex flex-col gap-5 p-5">
      <div>
        <h3 className="text-base font-bold text-[#272830] mb-1">CONVERSION OPTIONS</h3>
        <p className="text-xs text-[#737680]">Choose how text will be extracted into Word.</p>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        >
          ...
          <p className="text-xs text-[#686B74]">
            Convert PDFs containing selectable text into editable Word documents instantly.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-[#686B74]">
            Recognize scanned PDF pages with optical character recognition into editable Word text.
          </p>
        </div>
      </div>
    </div>
